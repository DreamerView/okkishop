...
const InstallPrompPwa = () => {
  ...
  const handleInstall = async () => {
    ...
    if (iOS() && !isStandalone) {
      ...
      const modalPrompt = new Modal(document.getElementById('pwaPromptModal'))
      modalPrompt.show()
  ...
  return (
    ...
    <div className="block_animation d-none d-md-flex position-fixed row mx-auto bg-dark text-white p-3 rounded-4 shadow" style={{ maxWidth: 300, width: "calc(100% - 32px)", bottom: "32px", zIndex: 3, right: '32px' }}>
      <div className="col-2 px-0">
        <Image src="/android/android-launchericon-48-48.png" className="rounded-3" alt="" width={40} height={40} />
      </div>
